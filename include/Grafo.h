...
public:
    ...
    vector<int> algoritmoGulosoRandomizado(float alfa, int maximoIteracoes, ofstream& arquivoDeSaida);
    ...
    void algoritmoGulosoRandomizadoReativo(int maximoIteracoesReativo, int maximoIteracoesRandomizado, int numeroDeAlfas, ofstream& arquivoDeSaida);
